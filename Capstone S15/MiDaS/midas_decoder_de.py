...
from MiDaS.blocks import FeatureFusionBlock, Interpolate, _make_encoder_scratch


class MidasDecoder(nn.Module):
    """Network for monocular depth estimation.
        from intel-isl/MiDaS repo
    """
    ...
    def __init__(self, path=None, features=256,non_negative=True):
        ...
        """
        refinenet:
        achieves high-resolution prediction(high-resolution semantic image segmentation) by explicitly
        exploiting all the information available along the down-sampling process
        and using long-range residual connections.
        """
