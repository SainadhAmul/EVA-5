...
def build_targets(p, targets, model):
    ...
    for i, j in enumerate(model.bbox_decoder.yolo_layers):
        # get number of grid points and anchor vec for this yolo layer
        anchors = model.bbox_decoder.module.module_list[j].anchor_vec if multi_gpu else model.bbox_decoder.module_list[j].anchor_vec
